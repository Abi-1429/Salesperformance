...
<img src="https://readme-typing-svg.herokuapp.com?font=Poppins&size=28&duration=3000&color=FF4D6D&center=true&vCenter=true&width=850&lines=Interactive+Sales+Analytics+Dashboard;Power+BI+Data+Visualization;Transforming+Data+Into+Insights" />
...
A[Sales Dataset] --> B[Data Cleaning]
B --> C[Power BI Modeling]
C --> D[KPI Cards]
C --> E[Trend Analysis]
